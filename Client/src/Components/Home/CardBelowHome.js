...
const CardBelowHome = () => {
  ...
  return (
    <div className='dark-grey-container'>
      ...
      <div className='left-para'><p><p className='adopted-pets-num'>{adoptedPets}</p>Thú cưng đã tìm được mái ấm</p></div>
      <div className='right-pic'><img src={HomeDarkCardRightPic} alt="Dog pic" /></div>
      <div className='right-para'><p className='we-do'>Hành trình được yêu thương</p>Nhiều tình nguyện viên đang hoạt động</div>
    </div>
  )
}
